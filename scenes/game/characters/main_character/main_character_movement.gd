...
var gravity = 325 # Gravedad para el personaje
var velocity = 100 # Velocidad de movimiento en horizontal
var jump = 150 # Capacidad de salto, entre mayor el número más se puede saltar
...
var _max_jumps = 300 # Máximo número de saltos
